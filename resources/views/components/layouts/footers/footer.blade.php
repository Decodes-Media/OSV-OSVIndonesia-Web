<footer>
    <div class="footer-top">
        <div class="container">
            <div class="row">
                <div class="col-12 col-lg-3 text-center text-md-left mb-4 mb-md-0 d-flex align-items-end">
                    <a href="#">
                        <img src="{{ asset('img/logo-black.png') }}" class="img-fluid footer-logo" alt="Logo" loading="lazy">
                    </a>
                </div>

                <div class="col-12 col-lg-6 text-center mb-4 mb-md-0 d-flex align-items-end">
                ...
                <div class="col-12 col-lg-3 text-center text-md-right d-flex align-items-end">
