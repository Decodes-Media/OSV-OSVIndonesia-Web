...
return new class extends SettingsMigration
{
    public function up(): void
    {
        ...
        $this->migrator->add('specialities.banner_desc', "<p>We believe that luxury is in the details. Our commitment to crafting exceptional luxury furniture is evident in every piece we create. Combining exquisite materials with masterful craftsmanship, we design furniture that not only enhances the aesthetic of your space but also provides unparalleled comfort and functionality. Our skilled artisans pay meticulous attention to every curve, finish, and texture, ensuring that each item is a true reflection of sophistication and elegance. Whether you're looking for bespoke pieces for a high-end hotel, a gourmet restaurant, or an upscale residential project, OSV brings your vision to life with a seamless blend of artistry and innovation, making luxury accessible for every space.</p>");
